    ...
    public partial class MainForm : Form
    {
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var users = collection.Find(Query.EQ("Name", findUserName));
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                collection.Remove(Query.EQ("Name", findUserName));
        ...
        private void button16_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                collection.Remove(Query.EQ("_id", findUserName));
        ...
        private void button17_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var query = Query.EQ("_id", findUserName);
                var fields = Fields.Include("Age").Include("NicNameList");
        ...
        private void button19_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var query = Query.And(Query.EQ("_id", findUserName), Query.GTE("Age", textBox4.Text.ToInt32()));
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var modifyArgs = new MongoDB.Driver.FindAndModifyArgs()
                {
                    ...
                    Update = MongoDB.Driver.Builders.Update.Set("NicNameList", new BsonArray(newNickNameList)),
