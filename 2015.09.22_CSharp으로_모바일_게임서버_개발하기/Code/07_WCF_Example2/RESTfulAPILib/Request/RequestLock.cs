...
namespace RESTfulAPILib.Request
{
    public class RequestLock : IDisposable
    {
        ...
        public async Task<ERROR_CODE> 요청_처리중인가Async([System.Runtime.CompilerServices.CallerFilePath] string fileName = "",
                                ...
                                [System.Runtime.CompilerServices.CallerLineNumber] int lineNumber = 0)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    await DB.Redis.SetStringAsync<double>(key, 0);
                }

                var changeData = await DB.Redis.IncrementAsync(key, curAllTimeSec);
