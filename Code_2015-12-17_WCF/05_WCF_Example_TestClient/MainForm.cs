...
namespace TestProject
{
    public partial class MainForm : Form
    {
        ...
        {
            var api = textBoxGameServerAddress.Text + "TestEncrypto";
            ...
            {
                WriteUILog(string.Format("[Error] RequestHttpAESEncry Response Error: {0}", responseJson.Data));
                return;
            }
        ...
        REQ_ENCRYTO_DATA EncryotRequestData<REQUSET_T>(string userID, REQUSET_T result)
        {
            ...
            var request = new REQ_ENCRYTO_DATA { UserID = userID, Data = encryData };
            return request;
        }
